...
namespace CycloneDDS.CodeGen.Emitters
{
    public class ViewExtensionsEmitter
    {
        ...
        /// <summary>
        /// Returns the static extensions class definition without a namespace wrapper, using a single-level indent.
        /// Used by CodeGenerator to compose a single combined output file per type.
        /// </summary>
        public string EmitExtensionsInsideNamespace(TypeInfo type, GlobalTypeRegistry registry)
        {
            var sb = new StringBuilder();
            var indent = "    ";
