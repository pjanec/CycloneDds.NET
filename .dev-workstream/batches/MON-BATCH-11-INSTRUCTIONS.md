# MON-BATCH-11: Desktop verification + Samples/Detail + Hover Tooltip + Text View (DMON-017 fix/021/022/023/024)
...
This batch completes the missing report and manual verification, and delivers the Samples/Detail panels plus Hover JSON tooltip and Text View panel. Use xUnit only for new tests (no MSTest). Complete the full batch end-to-end without pausing for approvals (build, test, fix root causes).
...
8. **Previous Review:** `.dev-workstream/reviews/MON-BATCH-10-REVIEW.md`
...
`.dev-workstream/reports/MON-BATCH-11-REPORT.md`

**If you have questions, create:**  
`.dev-workstream/questions/MON-BATCH-11-QUESTIONS.md`
...
This batch completes the desktop shell verification and delivers the core Samples/Detail UI plus JSON tooltip and text view panel.
...
- Submit the missing batch report with manual verification results.
- Implement Samples Panel and Detail Panel.
- Implement Hover JSON tooltip and Text View panel.
- Deliver required xUnit tests and manual checks.

---

## ? Tasks

### Task 0: Corrective — Submit batch report for DMON-017 verification

**File:** `.dev-workstream/reports/MON-BATCH-11-REPORT.md` (NEW)  
**Description:** Submit the full report including manual DMON-017 and DMON-024 checks.
...
- Verify Text View panel manual behaviors per DMON-024 (JSON formatting, mode toggles).
...
- [ ] Report submitted to `.dev-workstream/reports/MON-BATCH-11-REPORT.md`
