...
| MON-DEBT-024 | 2026-03-22 | MON-BATCH-29 | P2 | Plugins | BDC Settings do not persist to Workspace JSON. `BdcSettings` is an in-memory singleton that needs `WorkspacePersistenceService` integration. | MON-BATCH-30 | Pending |
