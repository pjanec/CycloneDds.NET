...
| MON-DEBT-012 | 2026-03-04 | User report | P2 | Desktop / Menu | Main menu should look like a normal pull-down menu with items, not a set of buttons in a single line. | N/A | ? |
