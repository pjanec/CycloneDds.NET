...
namespace CycloneDDS.Runtime.Tests.KeyedMessages
{
    ...
    {
        private static readonly uint[] _ops = new uint[] {67108864, 16973829, 0, 16973829, 4, 17039368, 8, 0, 117440513, 1, 117440513, 3};

        public static uint[] GetDescriptorOps() => _ops;

        private static readonly DdsKeyDescriptor[] _keys = new DdsKeyDescriptor[]
        {
            new DdsKeyDescriptor { Name = "SensorId", Offset = 8, Index = 0 },
            new DdsKeyDescriptor { Name = "LocationId", Offset = 10, Index = 1 },
        };
